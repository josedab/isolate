...
Never run untrusted code without limits. Even trusted code can have bugs that cause infinite loops or memory exhaustion.
:::
...
- Learn about [Capabilities](../guides/capabilities) in depth
