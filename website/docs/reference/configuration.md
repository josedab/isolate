...
```rust
    ...
    .capability(Capability::tcp_connect(vec!["db:5432".parse().unwrap()]))
...
- Module must be valid WASM (magic number `\0asm`)
- Memory limit must be > 0
- Stack size must be > 0
- Entry point must be a valid identifier
- Paths must be absolute for filesystem capabilities

## See Also

- [Resource Limits](../guides/resource-limits) - Detailed limit configuration
- [Capabilities](../guides/capabilities) - Capability system details
