...
Control cooperative scheduling granularity:

```rust
.preemption_interval(Duration::from_millis(10))  // Check limits every 10ms
```
...
**Warning:** Running untrusted code without limits is dangerous!
...
- [Capabilities](./capabilities.md) - Permission controls
- [Security Model](./security-model.md) - Defense in depth
- [Monitoring](./monitoring.md) - Tracking and alerting
